...
/**
 * Delete a description attached to an item
...
$descriptionid  = optional_param('descriptionid', 0, PARAM_INT);  // document ID
$cancel     = optional_param('cancel', 0, PARAM_BOOL);


$url = new moodle_url('/mod/checkskill/delete_description.php');
...
if ($chk = new checkskill_class($cm->id, 0, $checkskill, $cm, $course)) {
    $chk->delete_description($descriptionid);
}
