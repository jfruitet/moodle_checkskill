...
/**
 * The mod_checkskill report viewed event.
 *
...
/**
 * The mod_checkskill report viewed event class.
 *
 * @package    mod_checkskill
 * @since      Moodle 2.7
 * @package    mod_checkskill
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_checkskill');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed the report for {$userdesc}the checkskill with " .
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'checkskill', 'report', $url, $this->objectid, $this->contextinstanceid);
    }
}
