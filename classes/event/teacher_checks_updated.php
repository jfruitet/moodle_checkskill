...
/**
 * The mod_checkskill teacher checks updated event.
 *
...
/**
 * The mod_checkskill teacher checks updated class.
 *
 * @package    mod_checkskill
 * @since      Moodle 2.7
 * borrowed from package checklist 
...
class teacher_checks_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventteacherchecksupdated', 'mod_checkskill');
    }
