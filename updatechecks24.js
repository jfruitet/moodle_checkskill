        ...
        Y.use('yui2-dom', 'yui2-event', 'yui2-connection', 'yui2-animation', function (Y) {
            ...
            chk = {
                ...
                init: function (Y, url, sesskey, cmid, updateprogress) {
                    ...
                    this.updatelist = [];
                    items = YD.getElementsByClassName('checkskillitem');
                ...
                update_progress_bar: function () {
                    ...
                    prall = YD.get('checkskillprogressall');
                    prreq = YD.get('checkskillprogressrequired');

                    allpercent = (this.optionalchecked + this.requiredchecked) * 100.0 / (this.optionalcount + this.requiredcount);
                    inner = YD.getElementsByClassName('checkskill_progress_inner', 'div', prall)[0];
                    inneranim = YD.getElementsByClassName('checkskill_progress_anim', 'div', prall)[0];
                    ...
                    disppercent = YD.getElementsByClassName('checkskill_progress_percent', 'span', prall)[0];
