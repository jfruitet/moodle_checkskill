...
/**
 * This page prints a skill of all student's results
 *
...
$url = new moodle_url('/mod/checkskill/report.php');
if ($id) {
    ...
    print_error(get_string('error_specif_id','checkskill')); // 'You must specify a course_module ID or an instance ID'
}
...
$chk = new checkskill_class($cm->id, $studentid, $checkskill, $cm, $course);
$chk->report();
